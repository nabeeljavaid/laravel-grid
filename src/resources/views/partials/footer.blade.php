...
<div class="laravel-grid-footer">
    ...
    @elseif($__paginationStyle == 'INPUT')
        <div class="laravel-grid-pagination">
            <ul>
                ...
                <li><input type="text" name="page" id="laravel-grid-page" class="form-control input-sm" value="{{ $__page }}"/><span>&nbsp;&nbsp;of {{ $__total_pages }}</span></li>
    ...
    @elseif($__paginationStyle == 'SELECT')
        <div class="laravel-grid-pagination">
            <ul>
                ...
                <li>
                    <select name="page" id="laravel-grid-page" class="form-select form-select input-sm">
    ...
    @elseif($__recordsPerPageStyle == 'INPUT')
        <div class="laravel-grid-records-per-page"> Display: <input type="text" name="limit" id="laravel-grid-limit" class="form-control input-sm" value="{{ $__limit }}"/></div>
    @elseif($__recordsPerPageStyle == 'SELECT')
        <div class="laravel-grid-records-per-page"> Display:
            <select name="limit" id="laravel-grid-limit" class="form-select input-sm">
                @foreach($__recordsPerPage as $__record)
